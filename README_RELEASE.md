# Age of War: Sketchbook Edition 1.0.4
...
- Deterministic memory hygiene removes repeated model lines from summaries and rewrites stale repeated responses before display.
