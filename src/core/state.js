...
export function createState({ seed = 1, difficulty = 'normal', startAge = 0, opponent = true } = {}) {
  ...
  return { version: RULES_VERSION, seed, difficulty, tick: 0, nextId: 1, running: true, paused: false, winner: null,
